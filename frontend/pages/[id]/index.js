          ...
          {checks.length === 0 ? (
            ...
            checks.map((check) => (
              ...
              >
                <header
                  style={{ fontFamily: "Montserrat-Bold", fontSize: "25px" }}
                  className="mb-5 gap-5 pr-20 text-slate-800 font-semibold leading-6 max-md:flex-wrap max-md:pr-5 max-md:max-w-full"
                >
                  Detail Checks
                </header>
                <p
                ...
                >
                  Berikut detail medical record yang kamu buat!
                </p>
